...
namespace Client
{
	...
	enum INTERACTABLEID { INTERACTABLE_TREASURE, INTERACTABLE_BED, INTERACTABLE_END };
	enum ITEMID { ITEM_RUPEE_GREEN, ITEM_BOMB, ITEM_SHIELD, ITEM_SWORD, ITEM_ROCFEATHER, ITEM_OCARINA, ITEM_BOW, ITEM_END };
	...
	enum VTXTEXPASS { VTXTEX_DEFAULT, VTXTEX_UI, VTXTEX_UI_BLEND, VTXTEX_UI_BLEND_FADE_IN, VTXTEX_EFFECT_SMOKE, VTXTEX_EFFECT_HIT_FLASH, VTXTEX_EFFECT_BOMB_FLASH, VTXTEX_EFFECT_BOMB_EXPLOSION, VTXTEX_EFFECT_GET_ITEM, VTXTEX_END };
}
