...
namespace Client
{
	...
	enum VTXMODELPASS { VTXMODEL_DEFAULT, VTXMODEL_HITRING, VTXMODEL_SWISH, VTXMODEL_SWORDSLASH, VTXMODEL_HIT, VTXMODEL_GUARDRING, VTXMODEL_GUARD, VTXMODEL_SHOCKWAVERING, VTXMODEL_SHOCKWAVE, VTXMODEL_END };
