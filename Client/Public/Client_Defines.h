...
namespace Client
{
	...
	enum VTXMODELPASS { VTXMODEL_DEFAULT, VTXMODEL_SWORDSLASH, VTXMODEL_HITRING, VTXMODEL_HIT, VTXMODEL_GUARDRING, VTXMODEL_GUARD, VTXMODEL_SHOCKWAVERING, VTXMODEL_SHOCKWAVE, VTXMODEL_STAR, VTXMODEL_END };
