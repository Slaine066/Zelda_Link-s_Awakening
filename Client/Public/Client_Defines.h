...
namespace Client
{
	...
	enum VTXMODELPASS { VTXMODEL_DEFAULT, VTXMODEL_SWORDSLASH, VTXMODEL_HITRING, VTXMODEL_HIT, VTXMODEL_GUARDRING, VTXMODEL_GUARD, VTXMODEL_SHOCKWAVERING, VTXMODEL_SHOCKWAVE, VTXMODEL_STAR, VTXMODEL_COUNTDOWN, VTXMODEL_END };
	enum VTXTEXPASS { VTXTEX_DEFAULT, VTXTEX_UI, VTXTEX_UI_BLEND, VTXTEX_EFFECT_SMOKE, VTXTEX_EFFECT_HIT_FLASH, VTXTEX_EFFECT_BOMB_FLASH, VTXTEX_EFFECT_BOMB_EXPLOSION, VTXTEX_END };
}
