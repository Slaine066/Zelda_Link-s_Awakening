...
namespace Client
{
	...
	enum SOUND_ID { SOUND_BGM, SOUND_GROUND, SOUND_UI, SOUND_MONSTER_VOICE, SOUND_MONSTER_EFFECT, SOUND_OBJECT, SOUND_PLAYER, SOUND_NPC, SOUND_NPC_EFFECT, SOUND_SYSYEM, SOUND_END };
