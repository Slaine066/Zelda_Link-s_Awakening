...
namespace Client
{
	...
	enum ITEMID { ITEM_RUPEE_GREEN, ITEM_BOMB, ITEM_ROCFEATHER, ITEM_BOW, ITEM_OCARINA, ITEM_END };
	...
	enum VTXTEXPASS { VTXTEX_DEFAULT, VTXTEX_UI, VTXTEX_UI_BLEND, VTXTEX_EFFECT_SMOKE, VTXTEX_EFFECT_HIT_FLASH, VTXTEX_EFFECT_BOMB_FLASH, VTXTEX_EFFECT_BOMB_EXPLOSION, VTXTEX_EFFECT_GET_ITEM, VTXTEX_END };
}
